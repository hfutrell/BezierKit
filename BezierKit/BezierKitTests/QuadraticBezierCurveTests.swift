...
//
    func testInitializerStartEndMidT() {
        let q1 = QuadraticBezierCurve(start: BKPoint(x: 1.0, y: 1.0), end: BKPoint(x: 5.0, y: 1.0), mid: BKPoint(x: 3.0, y: 2.0), t: 0.5)
        XCTAssertEqual(q1, QuadraticBezierCurve(p0: BKPoint(x: 1.0, y: 1.0), p1: BKPoint(x: 3.0, y: 3.0), p2: BKPoint(x: 5.0, y: 1.0)))
        // degenerate cases
        let q2 = QuadraticBezierCurve(start: BKPoint(x: 1.0, y: 1.0), end: BKPoint(x: 5.0, y: 1.0), mid: BKPoint(x: 1.0, y: 1.0), t: 0.0)
        XCTAssertEqual(q2, QuadraticBezierCurve(p0: BKPoint(x: 1.0, y: 1.0), p1: BKPoint(x: 1.0, y: 1.0), p2: BKPoint(x: 5.0, y: 1.0)))
        let q3 = QuadraticBezierCurve(start: BKPoint(x: 1.0, y: 1.0), end: BKPoint(x: 5.0, y: 1.0), mid: BKPoint(x: 5.0, y: 1.0), t: 1.0)
        XCTAssertEqual(q3, QuadraticBezierCurve(p0: BKPoint(x: 1.0, y: 1.0), p1: BKPoint(x: 5.0, y: 1.0), p2: BKPoint(x: 5.0, y: 1.0)))
    }
    
    func testBasicProperties() {
        let q = QuadraticBezierCurve(p0: BKPoint(x: 1.0, y: 1.0), p1: BKPoint(x: 3.5, y: 2.0), p2: BKPoint(x: 6.0, y: 1.0))
        XCTAssert(q.simple)
        XCTAssertEqual(q.order, 2)
        XCTAssertEqual(q.startingPoint, BKPoint(x: 1.0, y: 1.0))
        XCTAssertEqual(q.endingPoint, BKPoint(x: 6.0, y: 1.0))
    }
...
//
    func testBoundingBox() {
        ...
        let q1 = QuadraticBezierCurve(p0: BKPoint(x: 1.0, y: 1.0), p1: BKPoint(x: 3.0, y: 3.0), p2: BKPoint(x: 5.0, y: 1.0))
        let expectedBoundingBox1 = BoundingBox(p1: BKPoint(x: 1.0, y: 1.0),
                                               p2: BKPoint(x: 5.0, y: 2.0))
        XCTAssertEqual(q1.boundingBox, expectedBoundingBox1)
       
        // hits codepath where midpoint pushes down x coordinate of bounding box
        let q2 = QuadraticBezierCurve(p0: BKPoint(x: 1.0, y: 1.0), p1: BKPoint(x: -1.0, y: 2.0), p2: BKPoint(x: 1.0, y: 3.0))
        let expectedBoundingBox2 = BoundingBox(p1: BKPoint(x: 0.0, y: 1.0),
                                               p2: BKPoint(x: 1.0, y: 3.0))
        ...
        let expectedBoundingBox3 = BoundingBox(p1: BKPoint(x: 1.0, y: 1.0),
                                               p2: BKPoint(x: 2.0, y: 1.75))
...
//    
    ...
    func testEquatable() {
        ...
        let p2 = BKPoint(x: 3.0, y: 2.0)

        let c1 = QuadraticBezierCurve(p0: p0, p1: p1, p2: p2)
        let c2 = QuadraticBezierCurve(p0: p0, p1: p1, p2: p2)
        let c3 = QuadraticBezierCurve(p0: BKPoint(x: 5.0, y: 6.0), p1: p1, p2: p2)
        let c4 = QuadraticBezierCurve(p0: p0, p1: BKPoint(x: 1.0, y: 3.0), p2: p2)
        let c5 = QuadraticBezierCurve(p0: p0, p1: p1, p2: BKPoint(x: 3.0, y: 6.0))
