...
class BezierKitTestHelpers {
    ...
    static internal func curve(_ c1: BezierCurve, matchesCurve c2: BezierCurve, overInterval interval: Interval = Interval(start: 0.0, end: 1.0), tolerance: BKFloat = 1.0e-5) -> Bool {
